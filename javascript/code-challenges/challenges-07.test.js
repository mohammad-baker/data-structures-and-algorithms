...
const howMuchPencil = (arr) => {


   let r=[]
for(let i =0;i<=arr.length;i++){
  let f=arr.slice(i,arr.length)
  r.push(f)
}
//   r.push(arr)
//   r.push(arr.slice(1,7))
//   r.push(arr.slice(2,7))
//   r.push(arr.slice(3,7))
//   r.push(arr.slice(4,7))
//   r.push(arr.slice(5,7))
//   r.push(arr.slice(6,7))
//   r.push(arr.slice(7,7))
//   console.log(r)
//   console.log(f)
return r
};
...
r.push(recipe.ingredients[0].slice(15, 23))
r.push(recipe.ingredients[1].slice(9,13))
r.push(recipe.ingredients[2].slice(9, 20))
r.push(recipe.ingredients[3].slice(9,14))
r.push(recipe.ingredients[4].slice(10, 26))
r.push(recipe.ingredients[5].slice(8, 20))
r.push(recipe.ingredients[6].slice(8, 19))
r.push(recipe.ingredients[7].slice(8, 21))
r.push(recipe.ingredients[8].slice(8, 16))
r.push(recipe.ingredients[9].slice(10, 23))
r.push(recipe.ingredients[10].slice(10, 21))
  // Solution code here...
  return r;
};
