...
Write a function named transformToLis that, given an object, returns an array of the key element pairs as html list vlues.
...
const divisibleByFiveTwoToThePower = (input) => {
  // Solution code here...
  let array = input.map((item) => item.filter((value) => value % 5 === 0 && typeof value === 'number')
...
returns the names of the elements whose gender is either male or female.

The names should be combined into a single string with each element name separated by "and".
...
let findMaleAndFemale = (data) => {
  ...
  return data.filter(item => {
    return item.gender === 'female' || item.gender === 'male';}).map(element => {
    return element.name;
  }).join(' and ');
...
Write a function named findShortest that, given the Star Wars data from Challenge 6, uses any combination of filter, map and reduce to return the name of the element who is the shortest in height.
------------------------------------------------------------------------------------------------ */

let findShortest = (data) => {
  // Solution code here...
  let array= data.reduce((A,B) =>{
...
describe('Testing challenge 1', () => {
  test('It should return a list of key element pairs inside of li tags', () => {
...
describe('Testing challenge 4', () => {
  ...
  test('It should return an empty array if the elements are not numbers', () => {
    expect(divisibleByFiveTwoToThePower([['one', 'two', 'five'], ['5', '10', '15'], [5]])).toStrictEqual([[], [], [32]]);
  });
});

describe('Testing challenge 5', () => {
  test('It should return only elements that are male or female', () => {
...
describe('Testing challenge 6', () => {
  test('It should return the name of the shortest element', () => {
